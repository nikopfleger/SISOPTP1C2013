...
t_configQuantum *config_create(char *path) {
	t_configQuantum *config = malloc(sizeof(t_configQuantum));
...
*/
bool config_has_property(t_configQuantum *self, char* key) {
...
*/
char *config_get_string_value(t_configQuantum *self, char *key) {
...
*/
int config_get_int_value(t_configQuantum *self, char *key) {
...
*/
long config_get_long_value(t_configQuantum *self, char *key) {
	char *value = config_get_string_value(self, key);
	return atol(value);
}
...
*/
double config_get_double_value(t_configQuantum *self, char *key) {
	char *value = config_get_string_value(self, key);
	return atof(value);
}
 ...
 * VALORES=[1,2,3,4,5]
*/
char** config_get_array_value(t_configQuantum* self, char* key) {
...
*/
int config_keys_amount(t_configQuantum *self) {
