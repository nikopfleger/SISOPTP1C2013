...
void *queue_get(t_queue *self,int number) {
	return list_get(self->elements, number);
}


/*
 * @NAME: queue_copy
 * @DESC: Copia la segunda cola a la primera
 */

void queue_copy(t_queue *q1, t_queue *q2) {
